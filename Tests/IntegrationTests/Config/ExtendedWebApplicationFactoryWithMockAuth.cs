...
view=aspnetcore-7.0#customize-webapplicationfactory
*/
...
// Create open SqliteConnection so EF won't automatically close it.
            ...
            {
                SqliteInMemoryConnection = new
                    SqliteConnection("DataSource=:memory:");
                var connection = SqliteInMemoryConnection;
                connection.Open();
                return connection;
            });
            services.AddDbContext<GameDbContext>((container, options) =>
            {
...
/* Source: https://www.youtube.com/watch?v=b1-KG_x-Y5Q */
    public ExtendedWebApplicationFactoryWithMockAuth<TProgram>
        SetAuthenticatedUser(params Claim[] claimSeed)
    {
        ...
        AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var claimsIdentity = new ClaimsIdentity(_claimSeed.GetSeeds(),
                IdentityConstants.ApplicationScheme);
